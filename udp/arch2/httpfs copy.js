...
function handleClient(pkt, rinfo) {
  ...
  switch (udp.getKeyByValue(udp.typeDict, p.type)) {
    case "Data":
      console.log(
        `Server got Data, sequenceNumber:${p.sequenceNumber}, expectedSequenceNumber:${expectedSequenceNumber}`
      );
      // Send data
      var data = "";
      ...
      console.log(
        `Server sent Data, sequenceNumber:${p.sequenceNumber}, expectedSequenceNumber:${expectedSequenceNumber}`
      );
      break;
    case "ACK":
      console.log(
        `Server got ACK, sequenceNumber:${p.sequenceNumber}, expectedSequenceNumber:${expectedSequenceNumber}`
      );
      // y+1
    ...
    case "SYN":
      console.log(`Server got SYN, sequenceNumber:${p.sequenceNumber}`);
      ...
      server.send(udp_pkt, rinfo.port, (err) => {});
      console.log(
        `Server sent SYN_ACK ${p.payLoad}, sequenceNumber:${p.sequenceNumber}, expectedSequenceNumber:${expectedSequenceNumber}`
      );
      break;
    case "SYN_ACK":
      // code block
